...
$.extend(true,myflow.config.props.props,{
	name : {name:'name', label:'流程名称', value:'test', editor:function(){return new myflow.editors.inputEditor();}},
	key : {name:'key', label:'流程标识', value:'test', editor:function(){return new myflow.editors.inputEditor();}},
...
$.extend(true,myflow.config.tools.states,{
	start : {
			...
			'end-cancel' : {showType: 'image',type : 'end-cancel',
				...
				text : {text:'取消'},
				img : {src : '/static/images/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			task : {showType: 'text',type : 'task',
				...
				props : {
					...
					assignee: {name:'assignee', label: '角色', value:'', editor: function(){return new myflow.editors.inputEditor();}},
