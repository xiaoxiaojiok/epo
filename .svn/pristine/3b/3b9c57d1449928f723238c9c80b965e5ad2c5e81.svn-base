		...
		<tr>
			<td valign="top">
				<div class="tableContentLeft">
					...
					<div class="navSupTitle"><a class="act" href="/knowledgeDictLibManage/knowledgeDictLibManageToAddLib" ><span>添加词库</span></a></div>
...
<!-- addPointInput start -->
 ...
 <!--  zaici                          -->
							...
							<div class="addPointInputBox addPointInputBox1">
								...
								<span class="inputDiv inputModifyDiv">
								<input type="textArea"  name = "kdlDetail"  value="${kdlDetail }"/>
								</span>
							</div>
...
<!-- submit start -->
						<div class="submitBox modifyBox">
							...
							<span class="returnBnt"><a href="/knowledgeDictLibManage/knowledgeDictLibManageLibManage"></a></span>
						</div>
