		...
		<tr>
			...
			<td class="tdBak" valign="top">
				<div class="tableContentRight">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;当前位置：&nbsp;&nbsp;<a href="/systemManage/index" >系统管理</a>&nbsp;>&nbsp;<a href="/systemManage/toGatherManage" >采集点管理</a>&nbsp;>&nbsp;添加采集点
					</div>
...
<form action="/webGatherNode/addGatherNode" method="post" id="form">
	...
	<div class="submitBox">
		...
		<span class="returnBnt"><a id="backUrl" href="/systemManage/toGatherManage"></a></span>
	</div>
	<!-- submit end -->
