...
function getItemVal(pageGo)
{
	...
	objParams['WaringDepartment[start]'] = rangDate[0];
	objParams['WaringDepartment[end]'] = rangDate[1];
...
{
	var tableHeader = '<tr><th align="center" width="35%">标题</th><th align="center" width="9%">来源类别</th><th align="center" width="18%">热度</th><th align="center" width="9%">涉及部门</th><th align="center" width="18%">发布时间</th><th align="center" width="9%">操作</th></tr>';
	var tableContent = '';
	if (response.data && response.data.length > 0){
		for(var i=0; i<response.data.length; i++) {
			tableContent += '<td title="'+response.data[i].fullTitle+'" align="center" width="35%"><div class="pTitle"><a target="_blank" href="'+response.data[i].url+'">'+response.data[i].title+'</a></div></td>';
			tableContent += '<td align="center" width="9%">'+response.data[i].type+'</td>';
			tableContent += '<td align="center" width="18%">'+response.data[i].hot+'</td>';
			tableContent += '<td align="center" width="9%">'+response.data[i].department+'</td>';
