		...
		<tr>
			<td valign="top">
				<div class="tableContentLeft">
					...
					<div class="navSupTitle"><a class="act" href="/systemManage/toAddGather" ><span>添加采集点</span></a></div>
			...
			<td class="tdBak" valign="top">
				<div class="tableContentRight">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;当前位置：&nbsp;&nbsp;<a href="/systemManage/index" >系统管理</a>&nbsp;>&nbsp;<a href="/systemManage/toGatherManage" >采集点管理</a>&nbsp;>&nbsp;更新采集点
					</div>
...
<input type="hidden" name="old_wgnUniqueId" value="${webGatherNode.wgnUniqueId }"/>
					...
					<table id="spiderItem" cellpadding="0" cellspacing="0" style="text-align:center">
						...
						<c:forEach items="${configItemList}" var="configItem">
							<tr>
								...
								<td><input name="item[variable][]" value="${configItem.variable}" alt="字段参数" size="16" /></td>
								<td><input name="item[regex][]" value="${configItem.regex}" alt="过滤正则式" size="16" /></td>
								<td><input name="item[unit][]" value='${configItem.unit}' alt="处理器" size="14" /></td>
								<td>
	...
	<div class="submitBox">
		...
		<span class="returnBnt"><a id="backUrl" href="/systemManage/toGatherManage?page=${page}"></a></span>
	</div>
	<!-- submit end -->
